...
?><br><br><br><br><br><br><br>
            <div class="container">
	         ...
	         location.href='join_quiz.php';
               ...
               $select_query="select * from quiz_and_ques where quiz_id=$quiz_id";
				...
				<form action="save_ans.php?quiz_id=<?php echo $quiz_id;?>" method="post">	   
	...
	<!--		/* <form action="save_ans.php?quiz_id=<?php echo $row['quiz_id']; ?> &question_id=<?php echo $row['id']; ?> &password=<?php echo "$password"; ?>" method="post">*/-->
			 <input type="radio" id="option" name="choosen_option[<?php echo $i; ?>]"  value="Option1" >
			 <label for="Option1"><h4><?php echo  $row['option1']; ?></h4></label><br>
			 <input type="radio" id="option" name="choosen_option[<?php echo $i; ?>]"  value="Option2" >
			 <label for="Option2"><h4><?php echo  $row['option2']; ?></h4></label><br>
			 <input type="radio" id="option" name="choosen_option[<?php echo $i; ?>]"  value="Option3" >
			 <label for="Option3"><h4><?php echo  $row['option3']; ?></h4></label><br>
			 <input type="radio" id="option" name="choosen_option[<?php echo $i; ?>]"  value="Option4">
		   ...
		   <?php 
	    	 ...
	    	 ?>
			 <input type="submit" class="btn btn-success btn-lg " value="Save your answer" />
			  </form>
			<!-- <a href="save_ans.php?quiz_id=<?php echo "$quiz_id";?>" class="btn btn-primary btn-block active">Submit Your Response</a>-->
		    </div>
		   </div>
